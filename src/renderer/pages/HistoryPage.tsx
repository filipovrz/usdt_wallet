  ...
  return (
    ...
    <div className="p-8 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button variant="secondary" onClick={load}><RefreshCw size={16} />{t.refresh}</Button>
              ...
              <div key={tx.id} className="py-4 space-y-2">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div>
                    ...
                    <Badge variant={tx.direction === 'in' ? 'success' : 'default'}>{tx.direction === 'in' ? t.incoming : t.outgoing}</Badge>
                  ...
                  <Button variant="ghost" onClick={() => window.open(getExplorerTxUrl(tx.network, tx.hash, settings.testnetMode), '_blank')}>
