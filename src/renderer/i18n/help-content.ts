  ...
  bg: {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          'Показва token баланс (USDT или HNT), native баланс (TRX/ETH/BNB/MATIC/SOL) и USD стойност.',
          'Превключвайте между TRON, Ethereum, BSC, Polygon и Solana с бутоните за мрежа.',
      ...
      },
      {
        ...
        content: [
          ...
          'TRC-20 депозити пристигат на TRON адреса (T…). ERC-20/BSC/Polygon — на Ethereum адреса (0x…).',
          'Solana (HNT/SOL) — на Solana адреса (base58, различен от TRON/EVM).',
        ],
      },
      {
        id: 'send',
        ...
        content: [
          ...
          'Solana HNT изисква SOL за такси (~0.000005 SOL). Можете да изпращате и native SOL.',
      ...
      },
      {
        ...
        content: [
          'Показва входящи и изходящи трансфери (USDT, HNT, native coins).',
          'Натиснете „Обнови“ за синхронизация с блокчейна.',
          'Иконата за explorer отваря транзакцията в Tronscan, Etherscan или Solscan.',
        ],
      },
      {
        id: 'address-book',
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          'TRC-20 deposits arrive at TRON address (T…). ERC-20/BSC/Polygon at Ethereum address (0x…).',
          'Solana (HNT/SOL) — at Solana address (base58, different from TRON/EVM).',
        ],
      },
      {
        id: 'send',
        ...
        content: [
          ...
          'Solana HNT requires SOL for fees (~0.000005 SOL). You can also send native SOL.',
      ...
      },
      {
        ...
        content: [
          'Shows incoming and outgoing transfers (USDT, HNT, native coins).',
          'Click "Refresh" to sync with the blockchain.',
          'Explorer icon opens the transaction in Tronscan, Etherscan, or Solscan.',
        ],
      },
      {
        id: 'address-book',
